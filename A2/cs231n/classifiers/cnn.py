...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    #print conv_relu_pool_out.shape, W2.shape
    relu_out , relu_cache = affine_relu_forward(conv_relu_pool_out, W2, b2)
    affline_out2 , affline_cache2 = affine_forward(relu_out, W3, b3)
    scores = affline_out2
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
    ...
    drelu_out, dW3, db3 = affine_backward(daffline_out, affline_cache2)
    dconv_relu_pool_out, dW2, db2 = affine_relu_backward(drelu_out, relu_cache)
